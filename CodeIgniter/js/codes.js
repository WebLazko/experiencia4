...
$(document).ready(function() {
  var tabla = $('#asignaturas').DataTable({
          ...
          bootbox.dialog({
            ...
            '<div class="form-group">' +
              '<div class="input-group">' +
                ...
                '</span>' +
                '<input type="text" id="agregar_codigo" class="form-control" placeholder="sinopsis" required>' +
              '</div>' +
            '</div>' +
            ...
            '<div class="form-group">' +
              ...
              '<div class="input-group">' +
                '<span class="input-group-addon">' +
                  '<i class="glyphicon glyphicon-tag"></i>' +
                '</span>' +
                '<input type="text" id="agregar_estreno" class="form-control" placeholder="fecha de estreno" required>' +
              '</div>' +
              ...
              '<div class="input-group">' +
                '<span class="input-group-addon">' +
                  '<i class="glyphicon glyphicon-tag"></i>' +
                '</span>' +
                '<input type="text" id="agregar_genero" class="form-control" placeholder="genero" required>' +
              '</div>' +
    ...
    columns: [
      {data: 'codigo', title: 'Sinopsis'},
      {data: 'nombre', title: 'Nombre'},
      {data: 'estreno', title: 'Estreno'},
